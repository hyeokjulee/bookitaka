...
## 2. Tech Stack
- Backend : Java 11, Spring Framework 5.3, Spring Boot 2.7, Spring Data JPA 2.7, QueryDSL 5.0, Thymeleaf 3.0, JUnit 4, Gradle
...
- EC2 내에서 빌드를 할 때에 빌드가 정상적으로 되지 않고 서버가 다운되는 문제가 있었습니다. t2.micro 인스턴스의 RAM이 1GB밖에 되지 않는 것이 원인이라고 생각했기 때문에 EC2 내에서 스왑 파일을 생성하고 생성한 스왑 파일을 스왑 공간에 추가해 문제를 해결했습니다.
