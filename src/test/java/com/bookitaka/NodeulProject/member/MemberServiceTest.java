...
public class MemberServiceTest {
    ...
    @BeforeEach
    void beforeTest() {
        Member member = new Member(null, testEmail, testPassword, "tester", "010-0101-0101", "F", "2222-22-22", MemberRoles.ADMIN, Token.REFRESH_TOKEN, null);
    ...
    public void signup() {
        ...
        Member member = new Member(null, email, "0000", "tester", "010-0101-0101", "F", "2222-22-22", MemberRoles.MEMBER, Token.REFRESH_TOKEN, null);
        //when
        memberService.signup(member);
        //then
